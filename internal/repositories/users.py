...
async def create_new_user(session: AsyncSession, id: int, username: str, invited_by: int, 
                          can_take_test: bool, rank: str):
    new_user = User(user_id=id, username=username, invited_by=invited_by, can_take_test=can_take_test, rank=rank)
